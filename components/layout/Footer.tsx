...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-line/60 bg-surface-alt dark:border-line-dark/60 dark:bg-surface-dark-alt">
      ...
      <div className="border-t border-line/60 py-6 dark:border-line-dark/60">
