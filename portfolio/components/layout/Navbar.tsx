  ...
  return (
    <header
      className={cn(
        ...
        "w-[calc(100%-1.5rem)] sm:w-[calc(100%-2.5rem)] md:w-full md:max-w-6xl",
    ...
    >
      <div
        ...
        className={cn(
          ...
          scrolled
            ? "opacity-100 bg-white/70 backdrop-blur-xl [-webkit-backdrop-filter:blur(20px)] saturate-150 dark:bg-black/70"
            : "opacity-0",
        )}
      />
