      ...
      <div className="flex flex-wrap gap-1.5 sm:gap-2">
        {FILTERS.map((f) => (
          <button
            ...
            className={`inline-flex items-center gap-1.5 sm:gap-2 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-[12px] sm:text-[13px] font-medium transition-[background-color,color] duration-200 ${
              filter === f.value
